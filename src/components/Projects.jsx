    ...
    <section id="projects" className="relative ui-section overflow-hidden py-16 sm:py-24 bg-transparent">
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-start">
          ...
          <div className="flex flex-col border border-white/10 rounded-2xl bg-[#0d0d0d]/80 backdrop-blur-md p-4 sm:p-6 shadow-2xl">
            {/* Header */}
          ...
          <div className="flex flex-col border border-white/10 rounded-2xl bg-[#0d0d0d]/80 backdrop-blur-md p-4 sm:p-6 shadow-2xl h-full justify-between">
            {/* Header */}
            <div className="flex items-center justify-between pb-4 mb-4 border-b border-white/5">
              <h3 className="text-lg sm:text-xl font-bold text-white flex items-center gap-2 tracking-wide">
                        ...
                        {isFront && (
                          ...
                          >
                            ...
                            <button
                              onClick={(e) => {
                                e.stopPropagation();
                                handleDeckClick((activeDeckIndex + 1) % projects.length);
                              }}
